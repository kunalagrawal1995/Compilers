...
function_definition : 
    ...
    compound_statement 
    {
        ...
        $$ = $4;
        localSymTab = new SymTab();				//reset localSymTab for next function/struct.
        para_index = 1;
        global_offset = 0;
...
postfix_expression: 
    ...
    | IDENTIFIER '(' ')'
    {
        ...
        std::vector<ExpAst *> v;
        function_parameter_match(id, v);  			// function existance checked in function_parameter_match
        ExpAst *a = new FUNC(id, e);
	...
	| IDENTIFIER '(' expression_list ')' 
	{
        ...
        function_parameter_match(id, Exp_List);  // function existance checked in function_parameter_match
