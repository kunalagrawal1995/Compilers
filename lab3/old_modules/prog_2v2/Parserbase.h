// Generated by Bisonc++ V4.05.00 on Sun, 24 Apr 2016 03:18:32 +0530
...
// $insert polymorphicSpecializations
    ...
    struct TagOf<SymRow*>
    {
        static Tag__ const tag = Tag__::SYMROW;
    };

    template <>
    struct TagOf<std::vector<SymRow*>>
    {
        static Tag__ const tag = Tag__::VECSYMROW;
    };
    ...
    template <>
    struct TagOf<std::pair<SymTab *, abstract_astnode *>>
    {
        static Tag__ const tag = Tag__::FNDATA;
    };

    template <>
    struct TagOf<EXP_GROUP*>
    {
        static Tag__ const tag = Tag__::EXPGP;
    };

    template <>
    struct TagOf<SymTab *>
    {
        static Tag__ const tag = Tag__::SYMTAB;
    };
    ...
    template <>
    struct TagOf<std::pair<string,int>>
    {
        static Tag__ const tag = Tag__::TYPEPAIR;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::SYMROW>
    {
        typedef SymRow* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::VECSYMROW>
    {
        typedef std::vector<SymRow*> DataType;
    };

    template <>
    struct TypeOfBase<Tag__::ABS>
    {
        typedef abstract_astnode* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::FNDATA>
    {
        typedef std::pair<SymTab *, abstract_astnode *> DataType;
    };

    template <>
    struct TypeOfBase<Tag__::EXPGP>
    {
        typedef EXP_GROUP* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::SYMTAB>
    {
        typedef SymTab * DataType;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::TYPEPAIR>
    {
        typedef std::pair<string,int> DataType;
    };
